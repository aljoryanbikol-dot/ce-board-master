...
export class HintService {
  ...
  private async loadPublished(questionId: string) {
    const q = await this.prisma.question.findFirst({
      ...
      select: { id: true, subjectId: true, topicId: true, stemText: true, correctChoice: true, explanationText: true, questionStatus: true, situation: { select: { situationText: true } } },
    });
